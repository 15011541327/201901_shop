        ...
        <ul>
          <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend"  v-for="(rec,index) in rating.recommend" :key="index">
                <span class="iconfont" :class="rating.rateType===0 ? 'icon-thumb_up' : 'icon-thumb_down'">></span>
                <span class="item">{{rec}}</span>
              </div>
...
<script>
  ...
  export default{
    ...
    computed:{
      ...
      filterRatings(){
        /*
        1、selectType  0满意,1不满意,2全部
         rateType: 0/1   rating中的rateType
         selectType ====2 显示   ||  selectType===rateType

         2、onlyShowText ：true/false
                 text   : 有值、没值                  rating中的rateType
         onlyShowText:true     text.length>0    显示有值部分
         onlyShowText:false                      全显示
         !onlyShowText || text.length>0        全显示||显示有值的部分
         */
